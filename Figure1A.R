...
clinic = read.csv('clinical_48.csv', header = T, row.names = 1)
...
# plot
panel = c('IGHV1-69-2','SCGB1A1','SEC14L3','CCL7','MARCO','CCL18','MS4A4A',
          'MAGEA10','MAGEA4','MAGEA1','AKR1B15','CERS3','SERPINB12','COL17A1')
genelist = etSig[etSig$gene %in% panel,]
genelist = subset(genelist, select = -up_down)
